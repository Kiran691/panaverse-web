...
export default function HighLights() {
  return (
    <Box py={"50"}>
      ...
      <Box textAlign={"center"}>
        ...
        Because these beautiful and responsive React components will help you realize your next idea in no time.
        </Text>
      </Box>
      <Container maxW={1200}>
        <Flex gap={5}>
  ...
  <IoIosSpeedometer size={80}/>
    ...
    <Heading size='md' mt="5"> Speed up your workflow</Heading>
  </CardHeader>
  <CardBody>
...
<Card align='center'>
  ...
  <FaHandPeace size={80}/>
    ...
    <Heading size='md' mt="5"> Support Chakra UI</Heading>
  </CardHeader>
  <CardBody>
    <Text align={"center"}>Quickly put together different components to create an nearly infinite combination of user experiences.</Text>
  </CardBody>
